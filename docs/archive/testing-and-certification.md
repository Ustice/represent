> Historical testing-process specification. Retired from contributor workflow.
> Retained clause identifiers explain existing test records and campaigns.
> Current certification requirements live in
> [testing and certification](../specifications/testing-and-certification.md).
