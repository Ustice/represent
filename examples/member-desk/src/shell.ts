...
export function renderPage(
  ...
  document.title = `${section} · Fieldwork`;
  ...
  element("#app").innerHTML = `<div class="shell">
    ...
    <nav class="workspace-nav" aria-label="Workspace"><a class="nav-item ${section === "Members" ? "selected" : ""}" id="nav-members" href="#members" ${section === "Members" ? 'aria-current="page"' : ""}><span aria-hidden="true">◉</span> Members</a><a class="nav-item ${section === "Events" ? "selected" : ""}" id="nav-events" href="#events" ${section === "Events" ? 'aria-current="page"' : ""}><span aria-hidden="true">▦</span> Events</a></nav>
