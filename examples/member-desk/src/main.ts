...
function element<Element extends HTMLElement>(selector: string) {
...
function render() {
  ...
  const focusSelector =
    focused instanceof HTMLElement
      ? focused.id
        ...
        : focused.dataset.view
          ? `[data-view="${CSS.escape(focused.dataset.view)}"]`
          : focused.dataset.member
            ? `[data-member="${CSS.escape(focused.dataset.member)}"]`
            : undefined
      : undefined;
  ...
  element("#app").innerHTML = `<div class="shell">
    <aside class="sidebar"><a class="brand" href="#" aria-label="Fieldwork home"><span class="brand-mark">f.</span>fieldwork</a><div class="workspace-label">COMMUNITY WORKSPACE</div><div class="nav-item selected"><span aria-hidden="true">◉</span> Members <span class="nav-count">${members.length}</span></div><div class="sidebar-bottom"><span class="tiny-mark">r</span><div>Built with Represent<small>A working example</small></div></div></aside>
    <main><header class="topbar"><span>Workspace <span class="breadcrumb-slash">/</span> <strong>Members</strong></span><span class="demo-badge"><span class="little-dot"></span>Local demo</span></header>
